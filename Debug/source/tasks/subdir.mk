...
C_SRCS += \
../source/tasks/task_canopen.c \
../source/tasks/task_fusion.c \
../source/tasks/task_imu.c 

C_DEPS += \
./source/tasks/task_canopen.d \
./source/tasks/task_fusion.d \
./source/tasks/task_imu.d 

OBJS += \
./source/tasks/task_canopen.o \
./source/tasks/task_fusion.o \
./source/tasks/task_imu.o 


# Each subdirectory must supply rules for building sources it contributes
source/tasks/%.o: ../source/tasks/%.c source/tasks/subdir.mk
	@echo 'Building file: $<'
...
clean-source-2f-tasks:
	-$(RM) ./source/tasks/task_canopen.d ./source/tasks/task_canopen.o ./source/tasks/task_fusion.d ./source/tasks/task_fusion.o ./source/tasks/task_imu.d ./source/tasks/task_imu.o
