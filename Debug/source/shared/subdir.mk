...
C_SRCS += \
../source/shared/semaphores.c \
../source/shared/shared_data.c 

C_DEPS += \
./source/shared/semaphores.d \
./source/shared/shared_data.d 

OBJS += \
./source/shared/semaphores.o \
./source/shared/shared_data.o 


# Each subdirectory must supply rules for building sources it contributes
source/shared/%.o: ../source/shared/%.c source/shared/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-shared

clean-source-2f-shared:
	-$(RM) ./source/shared/semaphores.d ./source/shared/semaphores.o ./source/shared/shared_data.d ./source/shared/shared_data.o

.PHONY: clean-source-2f-shared
